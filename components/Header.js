...
class Header extends React.Component {
  ...
  renderRight = () => {
    ...
    switch (routeName) {
      ...
      case 'Woman':
        return ([
          <ChatButton key='chat-woman' navigation={navigation} isWhite={white} />,
          <BasketButton key='basket-woman' navigation={navigation} isWhite={white} />
        ]);
      case 'Man':
        return ([
          <ChatButton key='chat-man' navigation={navigation} isWhite={white} />,
          <BasketButton key='basket-man' navigation={navigation} isWhite={white} />
        ]);
      case 'Kids':
        return ([
          <ChatButton key='chat-kids' navigation={navigation} isWhite={white} />,
          <BasketButton key='basket-kids' navigation={navigation} isWhite={white} />
        ]);
      case 'Deals':
        return ([

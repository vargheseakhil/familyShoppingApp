...
const HomeStack = createStackNavigator({
  ...
  Man: {
    screen: ManScreen,
    navigationOptions: ({navigation}) => ({
      header: <Header search tabs title="Man" navigation={navigation} />,
    })
  },
  Woman: {
    screen: WomanScreen,
    navigationOptions: ({navigation}) => ({
      header: <Header search tabs title="Woman" navigation={navigation} />,
    })
  },
  Kids: {
    screen: KidsScreen,
    navigationOptions: ({navigation}) => ({
      header: <Header search tabs title="Kids" navigation={navigation} />,
    })
  },
  Pro: {
    screen: ProScreen,
